    ...
    <Protected>
      <div className="sm:mt-21 bg-gradient-to-br from-red-200 to-slate-500 min-h-screen p-4 sm:ml-64">
        <div className="sm:grid sm:grid-cols-3 sm:gap-4">
          ...
          <div className="sm:col-span-3 flex flex-row items-center justify-between">
            ...
            <button
              ...
              className="mr-4 px-4 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition-colors flex items-center gap-2"
            >
          ...
          <div className="sm:col-span-1 mt-4 bg-white rounded-lg p-4 border border-gray-200 max-h-[600px] overflow-y-auto">
            ...
            {/* Sample Templates */}
            <div className="mb-4">
              <h4 className="text-sm font-medium text-gray-600 mb-2">Sample Templates</h4>
          ...
          <div className="sm:col-span-2 space-y-4 mt-4">
            <div className="sm:grid sm:grid-cols-2 sm:gap-4">
              ...
              {/* Group Selection */}
              <div className="sm:col-span-1">
                <label className="block text-sm font-medium text-gray-700 mb-2">Select by Group</label>
                  ...
                  <div className="flex items-center gap-2 p-2 border border-white rounded-md bg-white">
                    ...
                    {groupSearchQuery && filteredGroups.length === 0 && (
                      <button 
                        ...
                        className="px-2 py-1 bg-green-500 text-white rounded hover:scale-95 cursor-pointer"
                      >
                        ✓
                      </button>
                    )}
                ...
                <div className="relative">
                  ...
                  {searchResults.length > 0 && (
                    <div className="absolute left-0 right-0 mt-1 bg-white border border-gray-300 rounded-md z-20 max-h-40 overflow-y-auto">
                      <button onClick={addAllSearchResults} className="w-full text-left px-3 py-2 text-sm hover:bg-gray-100 font-semibold text-purple-600">Add all results</button>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      ...
                      {imageUrl || uploadedImage ? 'Edit Image' : 'Add Image'}
                    </button>
                    <button
                      onClick={() => setShowPreview(!showPreview)}
                      className="flex items-center gap-2 px-3 py-1 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-sm"
                ...
                {(imageUrl || uploadedImage) && (
                  <div className="mb-3 p-3 bg-gray-50 border border-gray-200 rounded-lg flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <p className="text-sm font-medium text-gray-700">Image added</p>
              ...
              <div className="sm:col-span-2 mt-4">
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 flex items-center gap-2 cursor-pointer"
                  >
                    <FileText className="w-4 h-4" />
                    Save as Draft
                  </button>
                  ...
                  }} className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center gap-2 cursor-pointer justify-center">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              ...
              <div className="space-y-4">
                ...
                {/* Image Width */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Image Width (px)</label>
                  <input
                    type="number"
                    value={imageWidth}
            ...
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
              ...
              {drafts.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400 mt-1">Save your work in progress to continue later</p>
                </div>
              ) : (
